...
<div className=" bg-black text-white">
      <ContainerStagger className="relative z-[9999] h-full -mb-12 place-self-center px-6 pt-12 text-center">
        <ContainerAnimated>
          <h1 className="font-serif text-4xl font-extralight md:text-5xl">
            Your{" "}
            <span className="font-serif font-extralight text-blue-600">
              one source
            </span>
          </h1>
        </ContainerAnimated>
      ...
      style={{
            background: "linear-gradient(to right, gray, rebeccapurple, gray)",
            filter: "blur(84px)",
            mixBlendMode: "screen",
          }}
      />
