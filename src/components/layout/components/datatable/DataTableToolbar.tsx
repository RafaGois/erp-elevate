...
import { EyeOff, SlidersHorizontal, Users } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
        ...
        {form && (
          <Form {...form}>
            ...
            >
              ...
              {responsibleFilterOptions && onToggleResponsibleFilter && (
                <Popover>
                  <PopoverTrigger asChild>
                    <Button type="button" variant="outline" size="sm" className="gap-2">
                      ...
                      {responsibleFilterOptions.map((responsible) => {
                        ...
                        return (
                          <button
                            key={responsible.id}
                            type="button"
                            onClick={() => onToggleResponsibleFilter(responsible.id)}
                            className="hover:bg-muted flex w-full items-center justify-between rounded-md px-2 py-1.5 text-left text-sm"
                          >
