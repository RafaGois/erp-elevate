...
import { Separator } from "@/templates/ui/separator";
import { Button } from "@/templates/ui/button";
import { Badge } from "@/templates/ui/badge";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
  ...
  (
    {
      ...
      defaultValue = [],
      fetching,
      placeholder = !fetching ? "Selecione as opções" : "Carregando...",
      animation = 0,
      maxCount = 3,
      modalPopover = false,
      className,
